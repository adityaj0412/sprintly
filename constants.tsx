...
export const PRIORITY_CONFIG = {
  [Priority.URGENT]: {
    label: 'Urgent',
    color: 'text-white bg-rose-600 border-rose-700',
    dot: 'bg-white',
    order: 0,
  },
  [Priority.HIGH]: {
    label: 'High',
    color: 'text-white bg-amber-600 border-amber-700',
    dot: 'bg-white',
    order: 1,
  },
  [Priority.MEDIUM]: {
    label: 'Medium',
    color: 'text-white bg-blue-600 border-blue-700',
    dot: 'bg-white',
    order: 2,
  },
  [Priority.LOW]: {
    label: 'Low',
    color: 'text-slate-700 bg-slate-200 border-slate-300 dark:text-slate-300 dark:bg-slate-800 dark:border-slate-700',
    dot: 'bg-slate-400',
    order: 3,
  },
};
